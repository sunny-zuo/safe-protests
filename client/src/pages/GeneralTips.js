	...
	return (
		<div>
			...
			<ul>
				<li>
					{" "}
					Plan ahead: For essential needs, careand supplies. Know what to
					expect.Know how to get assistance. Plan forhow to re-contact your
					buddies if separated
				</li>
				<li>
					Be calm and focused: when things get intense, react to danger and
					warning signs sooner not later
				</li>
				<li>
					Watch for signs of physical and mental problems in yourself and
					others. Coold down others who exhibit panic behaviour
				</li>
				<li>
			...
			<ul>
				...
				<li>
					Don't go alone, if you can help it - go with an affinity group or some
					friends who know you well
				</li>
				<li>Don't forget to eat food and drink lots of water</li>
			</ul>
			<h2>
				<b>What To Bring</b>
			</h2>
			...
			<ul>
				...
				<li>
					Wearing contcts: you must remove the lenses or get someone to remove
